...
public class EdgeInventory {
	...
	public String apiInventoryParts(@HeaderParam("_") String someValue) {
		...
		System.out.println("### [Inventory] Player Parts request from player ID " + player.getPid() + ".");
	    return edgeInventoryBE.fetchFakePerformanceInventory(player.getPid());
	}
	...
	public String apiInventoryGetBlueprints() {
		...
		rootObject.addProperty("pid", player.getPid()); // player id
		...
		System.out.println("### [Inventory] Blueprints request from player ID " + player.getPid() + ".");
	    return rootArray.toString();
	}
	...
	public String apiPartsInstall(String requestBody, @PathParam(value = "vehicleId") String vehicleId,
		...
		edgeSocketVehiclesBE.prepareAssetVehicleUpdate(player.getPid(), "/asset/vehicles/update");
		// TODO Parts inventory status socket request

		System.out.println("### [Inventory] Install performance part ID " + itemId + " on Vehicle ID " 
				+ vehicleId + " request from player ID " + player.getPid() + ".");
	    return updatedCar;
	}
	...
	public String apiBlueprintsProduce(@PathParam(value = "objectId") String objectId) {
		...
		carJson.addProperty("pid", player.getPid());
		...
		System.out.println("### [Inventory] Blueprints Produce (Vehicle ID " + "16660" + ") request from player ID " 
				+ player.getPid() + ".");
	...
	public String apiUseInventoryItem(@PathParam(value = "playerId") String playerId, @PathParam(value = "itemId") String itemId) {
		...
		System.out.println("### [Inventory] Use inventory item request from player ID " + playerId + ".");
	    return json;
	}
	...
	public Response apiRemoveItem(String requestBody, @PathParam(value = "playerId") String playerId, 
		...
		System.out.println("### [Inventory] Remove customization item ID " + itemId
				+ " request from player ID " + playerId + ".");
