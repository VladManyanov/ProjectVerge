...
public class EdgeTimeTrial {
	...
	public String apiTTSeasons() {
		...
		System.out.println("### [Time Trial] Seasons information request from player ID " + player.getPid() + ".");
	...
	public String apiTTSeasonsCurrentMedals() {
		...
		System.out.println("### [Time Trial] Season medals data request from player ID " + player.getPid() + ".");
	    return json;
	}
	...
	public String apiTTGetTrackDetails(@PathParam(value = "trackId") String trackId) {
		...
		System.out.println("### [Time Trial] Track details request from player ID " + player.getPid() + ", track code: " + trackId + ".");
	    return json;
	}
	...
	public String apiTTGetTrackRecords(@PathParam(value = "trackId") String trackId) {
		...
		System.out.println("### [Time Trial] Track records request from player ID " + player.getPid() + ", track code: " + trackId + ".");
	    return json;
	}
